...
void Block::drawTop() {
	vao.Bind();
	glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(24 * sizeof(GLuint)), ibo.numInstances);
    vao.Unbind();
}
void Block::drawBottom() {
	vao.Bind();
	glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(30 * sizeof(GLuint)), ibo.numInstances);
    vao.Unbind();
}
void Block::drawNorth() {
	vao.Bind();
	glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(0 * sizeof(GLuint)), ibo.numInstances);
    vao.Unbind();
}
void Block::drawSouth() {
	vao.Bind();
	glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(6 * sizeof(GLuint)), ibo.numInstances);
    vao.Unbind();
}
void Block::drawEast() {
	vao.Bind();
	glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(18 * sizeof(GLuint)), ibo.numInstances);
    vao.Unbind();
}
void Block::drawWest() {
	vao.Bind();
	glDrawElementsInstanced(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(12 * sizeof(GLuint)), ibo.numInstances);
    vao.Unbind();
}
